# Migration Guide: UnrealORM 1.x → 2.0 Alpha

This guide helps you upgrade your UnrealORM codebase from 1.x to 2.0 alpha. The 2.0 release includes major improvements including transaction support, SurrealDB 2.0 integration, and enhanced update APIs.

## Table of Contents

- [Breaking Changes](#breaking-changes)
- [Step-by-Step Migration](#step-by-step-migration)
- [Transaction Migration](#transaction-migration)
- [Update API Migration](#update-api-migration)
- [SurrealDB 2.0 Migration](#surrealdb-20-migration)
...
UnrealORM 2.0 requires SurrealDB 2.0 alpha. Update your dependencies:
...
npm install surrealdb@^2.0.0-alpha.14 @surrealdb/node@2.3.4

# Update UnrealORM
npm install unrealorm@^2.0.0-alpha.1
```
...
// 3. JSON Patch operations (new in 2.0)
...
if (!db.isFeatureSupported(Features.Transactions)) {
  console.log("Transactions require SurrealDB 2.0+");
...
**Note**: This is an alpha release. Some APIs may change before the final 2.0 release. Check the [GitHub repository](https://github.com/Jimpex/unreal-orm) for the latest updates.
